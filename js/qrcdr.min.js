...
!(function (e, t) {
  ...
  return (function (e) {
              ...
              [
                ...
                },
                {
                  ...
                  value: function (t) {
                    return (
                      !(
                        !(t = t instanceof e ? t : new e(t)).isValid() ||
                        !this.isValid()
                      ) &&
                      this.hue === t.hue &&
    ...
    function (e, t, o) {
      ...
      var s = { colors: null, namesAsValues: !0 },
        c = (function (e) {
          function t(e) {
            var o =
              arguments.length > 1 && void 0 !== arguments[1]
            ...
            var n = (function (e, t) {
              ...
              (t.__proto__ || Object.getPrototypeOf(t)).call(
                this,
                e,
                a.default.extend(!0, {}, s, o),
              ),
            )
            return (
              Array.isArray(n.options.colors) ||
                'object' === r(n.options.colors) ||
    ...
    function (e, t, o) {
      var r = o(5),
        n = {}
      for (var i in r) r.hasOwnProperty(i) && (n[r[i]] = i)
      var a = (e.exports = {
      ...
      for (var l in a)
        if (a.hasOwnProperty(l)) {
          ...
          delete a[l].channels,
            delete a[l].labels,
            Object.defineProperty(a[l], 'channels', { value: s }),
            Object.defineProperty(a[l], 'labels', { value: c })
        }
      ;(a.rgb.hsl = function (e) {
        ...
        (a.rgb.hwb = function (e) {
          ...
          return [
            a.rgb.hsl(e)[0],
            100 * ((1 / 255) * Math.min(t, Math.min(o, r))),
            100 * (r = 1 - (1 / 255) * Math.max(t, Math.max(o, r))),
          ]
        }),
        (a.rgb.cmyk = function (e) {
          ...
          return [
            100 *
              ((1 - o - (t = Math.min(1 - o, 1 - r, 1 - n))) / (1 - t) || 0),
            100 * ((1 - r - t) / (1 - t) || 0),
            100 * ((1 - n - t) / (1 - t) || 0),
            100 * t,
          ]
        ...
        (a.xyz.rgb = function (e) {
          ...
          return (
            ...
            (t =
              (t = 3.2406 * n + -1.5372 * i + -0.4986 * a) > 0.0031308
        ...
        (a.lab.xyz = function (e) {
          var t,
            ...
            r,
            n = e[0]
          ;(t = e[1] / 500 + (o = (n + 16) / 116)), (r = o - e[2] / 200)
          var i = Math.pow(o, 3),
            a = Math.pow(t, 3),
            l = Math.pow(r, 3)
          return (
        ...
        (a.lab.lch = function (e) {
          var t,
            ...
            n = e[2]
          return (
            (t = (360 * Math.atan2(n, r)) / 2 / Math.PI) < 0 && (t += 360),
            [o, Math.sqrt(r * r + n * n), t]
          )
        }),
        ...
        (a.rgb.hcg = function (e) {
          var t,
            ...
            r = e[1] / 255,
            n = e[2] / 255,
            i = Math.max(Math.max(o, r), n),
            a = Math.min(Math.min(o, r), n),
            l = i - a
          return (
            (t =
              l <= 0
        ...
        (a.hcg.rgb = function (e) {
          ...
          return (
            (n = (1 - o) * r),
            [255 * (o * i[0] + n), 255 * (o * i[1] + n), 255 * (o * i[2] + n)]
          )
        }),
        (a.hcg.hsv = function (e) {
          var t = e[1] / 100,
            o = t + (e[2] / 100) * (1 - t),
            r = 0
          return o > 0 && (r = t / o), [e[0], 100 * r, 100 * o]
        }),
    ...
    function (e, t, o) {
      ...
      var l = 'colorpicker'
      ;(i.default[l] = n.default),
        (i.default.fn[l] = function (e) {
          var t = Array.prototype.slice.call(arguments, 1),
            o = 1 === this.length,
            a = null,
            s = this.each(function () {
              var s = (0, i.default)(this),
                c = s.data(l),
                u = 'object' === (void 0 === e ? 'undefined' : r(e)) ? e : {}
              c || ((c = new n.default(this, u)), s.data(l, c)),
                o &&
                  ((a = s),
                  'string' == typeof e &&
                    (a =
                      'colorpicker' === e
                        ? c
                        : i.default.isFunction(c[e])
                        ? c[e].apply(c, t)
                        : c[e]))
            })
          return o ? a : s
        }),
        (i.default.fn[l].constructor = n.default)
    },
    function (e, t, o) {
      'use strict'
      Object.defineProperty(t, '__esModule', { value: !0 })
      ...
      var k = 0,
        g = 'undefined' != typeof self ? self : void 0,
        y = (function () {
          function e(t, o) {
            !(function (e, t) {
              if (!(e instanceof t))
              ...
              (this.container =
                !1 !== this.container && (0, l.default)(this.container)),
              (this.inputHandler = new u.default(this)),
              (this.colorHandler = new h.default(this)),
              (this.sliderHandler = new s.default(this)),
              (this.popupHandler = new c.default(this, g)),
              (this.pickerHandler = new p.default(this)),
              (this.addonHandler = new f.default(this)),
              this.init(),
              (0, l.default)(
                l.default.proxy(function () {
            ...
            r(e, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (t = t instanceof d.default ? t : e) instanceof
                    d.default
      ...
      ;(y.extensions = a.default), (t.default = y), (e.exports = t.default)
    },
    function (e, t, o) {
      'use strict'
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      ;(t.Debugger = r.default),
        (t.Preview = n.default),
        (t.Swatches = i.default),
        (t.Palette = a.default),
        (t.default = {
          debugger: r.default,
          preview: n.default,
          ...
          return (
            ...
            r.colorpicker.inputHandler.hasInput() &&
              r.colorpicker.inputHandler.input.on(
                ...
                a.default.proxy(r.onChangeInput, r),
              ),
            r
          )
        }
    ...
    function (e, t, o) {
      ...
      var s = (function (e) {
        function t(e) {
          ...
          return (
            (r.element = (0, a.default)(r.options.template)),
            ...
            r(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  o.empty(),
                    i.default.each(this.colors, function (n, a) {
                      var l = (0, i.default)(e.options.swatchTemplate)
                        .attr('data-name', n)
                        .attr('data-value', a)
                        .attr('title', r ? n + ': ' + a : a)
                        .on(
                    ...
                    o.append(
                      (0, i.default)('<i class="colorpicker-clear"></i>'),
                    )
                },
              },
            ]),
              ...
              value: function (e) {
                if (!this.colorpicker.isDisabled()) {
                  ...
                  var t = (0, a.default)(e.target).closest('div'),
                    o = this.colorpicker.options.horizontal
                      ? this.colorpicker.options.slidersHorz
                      : this.colorpicker.options.sliders
                  if (!t.is('.colorpicker')) {
                    for (var r in ((this.currentSlider = null), o))
                      if (o.hasOwnProperty(r)) {
                        var n = o[r]
                        if (t.is(n.selector)) {
                          this.currentSlider = a.default.extend({}, n, {
                            name: r,
                          })
                          break
                        }
                        if (
                          void 0 !== n.childSelector &&
                          t.is(n.childSelector)
                        ) {
                          ;(this.currentSlider = a.default.extend({}, n, {
                            name: r,
                          })),
                    ...
                    var i = t.find('.colorpicker-guide').get(0)
                    if (null !== this.currentSlider && null !== i) {
                      var l = t.offset()
                      ;(this.currentSlider.guideStyle = i.style),
                        (this.currentSlider.left = e.pageX - l.left),
                        (this.currentSlider.top = e.pageY - l.top),
          ...
          r(e, [
            {
              ...
              value: function () {
                ...
                e.options.inline
                  ? e.picker.addClass('colorpicker-inline colorpicker-visible')
                  : (e.picker.addClass('colorpicker-popup colorpicker-hidden'),
                    (this.hasInput || this.hasAddon) &&
                      ...
                      this.hasAddon &&
                        ...
                        this.addon.on({
                          'mousedown.colorpicker touchstart.colorpicker': n.default.proxy(
                            this.toggle,
                            this,
                          ),
                        }),
                        ...
                        this.addon.on({
                          'focusout.colorpicker': n.default.proxy(
                            this.hide,
                            this,
                          ),
                        })),
                      ...
                      (0, n.default)(this.root).on(
                        'resize.colorpicker',
                        n.default.proxy(this.reposition, this),
                      )))
              },
            },
            {
              ...
              value: function () {
                this.hasInput &&
                  ...
                  this.input.off({
                    'focusout.colorpicker': n.default.proxy(this.hide, this),
                  })),
                  this.hasAddon &&
                    (this.addon.off({
                      'mousedown.colorpicker touchstart.colorpicker': n.default.proxy(
                  ...
                  (0, n.default)(this.root).off(
                    'resize.colorpicker',
                    n.default.proxy(this.reposition, this),
                  ),
                  (0, n.default)(this.root.document).off(
                    'mousedown.colorpicker touchstart.colorpicker',
                    n.default.proxy(this.hide, this),
                  ),
                  (0, n.default)(this.root.document).off(
                    'mousedown.colorpicker touchstart.colorpicker',
                    n.default.proxy(this.onClickingInside, this),
                  )
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e, t) {
                return (
                  !(!e || !t) &&
                  ((t = (0, n.default)(t)).is(e) || e.find(t).length > 0)
                )
              },
            },
            {
              ...
              value: function () {
                ...
                ;(this.popoverTarget = this.hasAddon ? this.addon : this.input),
                  ...
                  this.popoverTarget.on(
                    'shown.bs.popover',
                    n.default.proxy(this.fireShow, this),
                  ),
                  this.popoverTarget.on(
                    'hidden.bs.popover',
                    n.default.proxy(this.fireHide, this),
                  )
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ;(this.hidding = !1),
                  (this.showing = !1),
                  this.isPopover &&
                    ((0, n.default)(this.root.document).on(
                      'mousedown.colorpicker touchstart.colorpicker',
                      n.default.proxy(this.hide, this),
                    ),
                    (0, n.default)(this.root.document).on(
          ...
          r(e, [
            {
              ...
              value: function () {
                this.hasInput() &&
                  (this.input.on({
                    'keyup.colorpicker': n.default.proxy(this.onkeyup, this),
                  }),
                  this.input.on({
                    'change.colorpicker': n.default.proxy(this.onchange, this),
                  }))
              },
            },
            {
    ...
    function (e, t, o) {
      ...
      Object.keys(n).forEach(function (e) {
        l[i.call(n[e].labels).sort().join('')] = e
      })
      var s = {}
      function c(e, t) {
        if (!(this instanceof c)) return new c(e, t)
        if ((t && t in a && (t = null), t && !(t in n)))
        ...
        if (null == e)
          ...
          this.model = l[v]
          var k = n[this.model].labels,
            g = []
          for (o = 0; o < k.length; o++) g.push(e[k[o]])
          this.color = p(g)
        }
        if (s[this.model])
          for (u = n[this.model].channels, o = 0; o < u; o++) {
            var y = s[this.model][o]
      ...
      ;(c.prototype = {
        ...
        rotate: function (e) {
          var t = this.hsl(),
            o = t.color[0]
          return (
            (o = (o = (o + e) % 360) < 0 ? 360 + o : o), (t.color[0] = o), t
          )
        },
        mix: function (e, t) {
          if (!e || !e.rgb)
        ...
        Object.keys(n).forEach(function (e) {
          if (-1 === a.indexOf(e)) {
            ...
            ;(c.prototype[e] = function () {
              ...
              return new c(
                ((o = n[this.model][e].raw(this.color)),
                Array.isArray(o) ? o : [o]).concat(r),
                e,
              )
            }),
              (c[e] = function (o) {
                return (
                  'number' == typeof o && (o = p(i.call(arguments), t)),
                  new c(o, e)
                )
              })
          }
        ...
        (l.get.rgb = function (e) {
          ...
          if ((t = e.match(/^#([a-f0-9]{6})([a-f0-9]{2})?$/i))) {
            for (n = t[2], t = t[1], o = 0; o < 3; o++) {
              var a = 2 * o
              i[o] = parseInt(t.slice(a, a + 2), 16)
            }
            n && (i[3] = Math.round((parseInt(n, 16) / 255) * 100) / 100)
          } else if ((t = e.match(/^#([a-f0-9]{3,4})$/i))) {
            for (n = (t = t[1])[3], o = 0; o < 3; o++)
              i[o] = parseInt(t[o] + t[o], 16)
            n && (i[3] = Math.round((parseInt(n + n, 16) / 255) * 100) / 100)
          } else if (
            (t = e.match(
            ...
            if (
              ...
              return (t = e.match(/(\D+)/))
                ...
                : null
            for (o = 0; o < 3; o++)
              i[o] = Math.round(2.55 * parseFloat(t[o + 1]))
            t[4] && (i[3] = parseFloat(t[4]))
          }
    ...
    function (e, t, o) {
      ...
      function n(e) {
        var t = (function () {
            for (
              var e = {}, t = Object.keys(r), o = t.length, n = 0;
              n < o;
              n++
            )
        ...
        for (t[e].distance = 0; o.length; )
          for (
            var n = o.pop(), i = Object.keys(r[n]), a = i.length, l = 0;
            l < a;
            l++
          ) {
            var s = i[l],
              c = t[s]
            ;-1 === c.distance &&
              ((c.distance = t[n].distance + 1), (c.parent = n), o.unshift(s))
          }
        return t
      }
      function i(e, t) {
      ...
      function a(e, t) {
        for (
          var o = [t[e].parent, e], n = r[t[e].parent][e], a = t[e].parent;
          t[a].parent;

        )
          o.unshift(t[a].parent),
            (n = i(r[t[a].parent][a], n)),
            (a = t[a].parent)
        ...
        return (
          r(e, [
            ...
            },
            {
              ...
              value: function (e) {
                var t =
                    !(arguments.length > 1 && void 0 !== arguments[1]) ||
                    arguments[1],
                  o = new i.default(this.resolveColorDelegate(e), this.format)
                return (
                  o.isValid() ||
              ...
              value: function () {
                ...
                return t.isValid()
                  ...
                  : (console.warn(
                    ...
                    this.color
                      ? this.color
                      : new i.default('#000000', this.format))
              },
            },
            {
              key: 'assureColor',
            ...
            },
            {
              ...
              value: function (e) {
                var t =
                  ...
                  o = !1
                return (
                  n.default.each(this.colorpicker.extensions, function (r, n) {
            ...
            },
            {
              key: 'hasColor',
              value: function () {
                return this.color instanceof i.default
              },
            },
            {
              key: 'fallback',
            ...
            },
            {
              ...
              value: function () {
                if (
                  ...
                  var e = {
                      background: this.colorpicker.colorHandler.getColorString(),
                    },
...
!(function (t, e) {
  ...
  return (
    ...
    (d.dialog = function (t) {
      ...
      if (
        ((t = (function (r) {
          ...
          ;(r = p.extend({}, m, r)).backdrop
            ? (r.backdrop =
                'string' != typeof r.backdrop ||
                'static' !== r.backdrop.toLowerCase() ||
                'static')
            : (r.backdrop = !1 !== r.backdrop && 0 !== r.backdrop && 'static')
          r.buttons || (r.buttons = {})
          return (
            (n = r.buttons),
            (i = w(n)),
      ...
      if (
        ...
        t.reusable || o.one('hide.bs.modal', { dialog: o }, x),
        t.onHide)
      ) {
      ...
      if (
        (t.reusable || o.one('hidden.bs.modal', { dialog: o }, y), t.onHidden)
      ) {
    ...
    (d.prompt = function () {
      ...
      return (
        (e = d.dialog(r)).off('shown.bs.modal', v),
...
!(function (t) {
  ...
  t.fn.extend({
    qrcdr: function (e) {
      ...
      return this.each(function () {
        var e = t(this)
        if (e.data('qrcdr')) return !0
        if (
          ((a = e.find('.qrcdr-form')),
          (c = a.find(':submit')),
          e.find('.qrcdr-form :input'),
          (T = e.find('#collapseSettings :input')),
          (n = e.find('.qrcdr-form :input[type="text"], .qrcdr-form textarea')),
          (o = e.find(
            '.qrcdr-form :input:not([type="text"]):not(textarea), .qrcolorpicker :input',
          )),
          (s = e.find('.linksholder')),
          (l = e.find('.qrcolorpicker')),
          (i = e.find('.colorpickerback')),
          (r = e.find('.preloader')),
          (d = e.find('.alert_placeholder .toast-body')),
          (p = e.find('#trans-bg')),
          (g = e.find('.resultholder')),
          (v = e.find('.generate_qrcode')),
          (u = e.find('.holdresult')),
          (x = e.find('.setvalue')),
          (y = e.find('.yesdonation')),
          (z = e.find('.nodonation')),
          (h = e.find('.collapse-control')),
          (m = e.find('.collapse-control-reverse')),
          (P = e.find('input[name=btc_account]')),
          (f = e.find('#upmarker')),
          (b = e.find('#event')),
          (O = e.find('#collapseSettings :input')),
          (S = e.find('a[data-toggle="tab"]')),
          (I = t('#getsec').val()),
          (V = e.find('#qrcdr-relative').val()),
          (w = 'no'),
          e.data('qrcdr', !0),
          (j.getSettings = function () {
            return (
              (e = O.filter(function (e, a) {
                return '' != t(a).val()
              }).serializeArray()),
              (a = {}),
          ...
          (j.updateCode = function () {
            return N()
          }),
          location.hash)
        ) {
          const t = location.href.split('#')
          e.find('a[data-toggle="tab"][href="#' + t[1] + '"]').tab('show')
        }
        t('[maxlength]').maxlength({
          ...
          t('.toast').toast(),
          l.colorpicker({ autoInputFallback: !1 }),
          ...
          p.on('change', function () {
            t(this).prop('checked')
              ? (i.colorpicker('setValue', 'transparent'),
                i.colorpicker('disable'))
              : i.colorpicker('enable')
          }),
          p.prop('checked')
            ? (i.colorpicker('setValue', 'transparent'),
              i.colorpicker('disable'))
            : i.colorpicker('enable')
        var _ = document.getElementsByClassName('needs-validation')
        Array.prototype.filter.call(_, function (t) {
          t.addEventListener(
            'submit',
            function (e) {
              e.preventDefault(),
        ...
        function N() {
          t('.toast').toast('hide'),
            ...
            (k = setTimeout(function () {
              a[0].checkValidity() || c.click(),
                i.colorpicker('enable'),
                r.fadeIn(100, function () {
                  var a = e.find(I + ' :input'),
                    n = 'section=' + I + '&'
                  ;(n += a
                    .filter(function (e, a) {
                      return '' != t(a).val()
                    ...
                    .serialize()),
                    (n += '&'),
                    (n += T.filter(function (e, a) {
                      return '' != t(a).val()
                    }).serialize()),
                    t
                      .ajax({
                        type: 'POST',
                        url: V + 'ajax/process.php',
                        cache: !1,
                        data: n,
                      })
                      .fail(function (e) {
                        d.html(e.statusText), t('.toast').toast('show')
                      })
                      .done(function (e) {
                        p.prop('checked') && i.colorpicker('disable')
                        var a = JSON.parse(e)
                        a.hasOwnProperty('errore')
                          ? (d.html(a.errore),
                            t('.toast').toast('show'),
                            g.html('<img src="' + a.placeholder + '">'),
                            r.fadeOut('slow'))
                          : (v.attr('disabled', !1),
                            g.html(a.content),
                            r.fadeOut('slow'),
        ...
        function A() {
          ...
          t.ajax({
            ...
            .done(function (a) {
              if (a.length) {
                var n = JSON.parse(a)
                if (n.error) bootbox.alert({ message: n.error, size: 'small' })
                else {
                  var o = n.filedir + '/' + n.basename,
                    c =
                  ...
                  ;(c =
                    ...
                    s.html(c),
                    v.attr('disabled', !0),
                    e.find('.print').on('click', function () {
                      var e, a
                      ;(e = t('.serve-svg').attr('href')),
                        (a = window.open(
                          'about:blank',
                          '_new',
                        )).document.open(),
        ...
        function R() {
          if (t('#map-canvas').length) {
            ;(L = t('#map-canvas').data('lat')),
              (M = t('#map-canvas').data('lng'))
            var e,
              a,
              n = new google.maps.LatLng(L, M),
              o = document.getElementById('pac-input'),
              c = document.getElementById('latlong'),
              s = document.getElementById('latbox'),
              l = document.getElementById('lngbox'),
              i = { zoom: 10, center: n }
            ;(C = new google.maps.Map(
              document.getElementById('map-canvas'),
              i,
            )),
              (a = new google.maps.places.SearchBox(o)),
              ...
              google.maps.event.addListener(e, 'dragend', function (t) {
                var a = e.getPosition().lat() + ',' + e.getPosition().lng()
                r(a)
              }),
              C.controls[google.maps.ControlPosition.TOP_LEFT].push(c),
              s.value.length > 0 &&
                l.value.length > 0 &&
                d(Number(s.value), Number(l.value)),
              google.maps.event.addListener(a, 'places_changed', function () {
                var t = a.getPlaces()
                if (0 != t.length)
                  for (var n, o = 0; (n = t[o]); o++)
                    e.setPosition(n.geometry.location),
                      C.setCenter(n.geometry.location),
                      r()
              })
          }
          var r = function () {
              ;(s.value = e.getPosition().lat()),
                (l.value = e.getPosition().lng()),
                N()
            },
            d = function (t, a) {
              C.setCenter({ lat: t, lng: a }),
                e.setPosition({ lat: t, lng: a }),
                r()
            }
          t('#latbox, #lngbox').on('input', function () {
            s.value.length > 0 &&
              l.value.length > 0 &&
              d(Number(s.value), Number(l.value))
          })
        ...
        n.on('input', function (e) {
          ...
          o.on('change', function (e) {
            var a = e.target
            t(a).hasClass('nopreview') || N()
          }),
          v.on('click', function () {
            A()
          }),
          t(document).on('click', '.svgtopng', function () {
            var e, a, n, o, c, s, l, i
            ;(l = t('.svgtopng')),
              (i = l.parent().find('.serve-png')),
              (c = l.parent().find('.preload-png')),
              l.addClass('d-none'),
              ...
              (e.onload = function () {
                var s = 2 * e.width,
                  r = 2 * e.height
                ;(a.width = s), (a.height = r), n.drawImage(e, 0, 0, s, r)
                var d = a.toDataURL()
                t.ajax({
                  type: 'POST',
                  url: V + 'ajax/png.php',
                  cache: !1,
                  data: { imgdata: d, filename: o },
                })
                  .fail(function (t) {
                    bootbox.alert(t.statusText)
                  })
                  .done(function (t) {
                    'error' == t
                      ? bootbox.alert({
          ...
          f.on('change', function (e) {
            if (
              ...
              a.type.indexOf('svg') > 0 && (w = 'svg'),
                (o.onload = function (e) {
                  ...
                  t('.custom-watermark .hold-custom-watermark').html(a),
                    (n.src = t('.logoselecta .btn-group-toggle label')
                      .last()
                      .find('img')
                      .attr('src')),
                    t('.custom-watermark').addClass('active'),
                    t('.custom-watermark input')
                      .val(e.target.result)
                      .prop('checked', !0)
                }),
                o.readAsDataURL(a),
                (n.onload = function () {
                  ...
                  if ('svg' !== w) {
                    if (0 == a || 0 == o)
                      return (
                        t('#upmarker').addClass('is-invalid'),
                        t('.logoselecta .btn-group-toggle label')
                          .last()
                          .remove(),
                        !1
                      )
                    e.getContext('2d').drawImage(n, 0, 0),
                      ...
                      (e.width = a),
                      (e.height = o),
                      e.getContext('2d').drawImage(n, 0, 0, a, o)
                    var c = e.toDataURL()
                    t('.logoselecta .btn-group-toggle label')
                      .last()
                      .find('img')
            ...
            } else t(this).addClass('is-invalid')
          }),
          b.length &&
            (t('.datetimepicker-input').datetimepicker({ format: 'LLL' }),
            t('.datetimepicker-input').on('change.datetimepicker', function (
              e,
            ) {
              var a = t(this).data('timestamp')
              t(a).attr('value', e.date.unix())
            })),
          (function (e, a) {
            if (t('#wpol-admin-map').length) {
              if (
                ((L = t('#wpol-admin-map').data('lat')),
                (M = t('#wpol-admin-map').data('lng')),
                'undefined' == typeof ol || null === ol)
              )
                return console.log('WARNING: OpenLayers Library not loaded'), !1
              var n = ol.proj.fromLonLat([M, L]),
                o = new ol.View({ center: n, zoom: 4 })
              C = new ol.Map({
                target: 'wpol-admin-map',
                view: o,
                layers: [new ol.layer.Tile({ source: new ol.source.OSM() })],
                controls: ol.control.defaults({
                  attributionOptions: { collapsible: !0 },
                }),
                interactions: ol.interaction.defaults({ mouseWheelZoom: !1 }),
              })
              var c,
              ...
              C.addOverlay(l),
                C.getInteractions().forEach(function (t) {
                  t instanceof ol.interaction.DragPan && (c = t)
                }),
                s.addEventListener('mousedown', function (t) {
                  c.setActive(!1), l.set('dragging', !0)
                }),
                C.on('pointermove', function (t) {
                  !0 === l.get('dragging') && l.setPosition(t.coordinate)
                }),
                C.on('pointerup', function (e) {
                  if (!0 === l.get('dragging')) {
                    c.setActive(!0), l.set('dragging', !1)
                    var a = e.coordinate,
                      n = ol.proj.toLonLat(a)
                    t('.venomaps-get-lat').val(n[1]),
                      t('.venomaps-get-lon').val(n[0]),
                      N()
                  }
                }),
                t('.venomaps-get-coordinates').on('click', function () {
                  var e = t(this),
                    a = t('.venomaps-set-address').val()
                  if (a.length > 3) {
                    e.hide()
                    ...
                    t.ajax({
                      ...
                      .done(function (e) {
                        ...
                        ;(n = (a = e)[0].lat),
                          (c = a[0].lon),
                          (s = ol.proj.fromLonLat([c, n])),
                          l.setPosition(s),
                          o.setCenter(s),
                          o.setZoom(6),
                          t('.venomaps-get-lat').val(n),
                          t('.venomaps-get-lon').val(c),
                          N()
                      })
                      .always(function () {
                        e.fadeIn()
                ...
                t('.setinput-latlon').on('input', function () {
                  !(function (t, e) {
                    var a = ol.proj.fromLonLat([e, t])
                    l.setPosition(a), o.setCenter(a)
                  })(t('.venomaps-get-lat').val(), t('.venomaps-get-lon').val())
                })
            }
          })(0, 'infomarker_admin'),
          R(),
          S.on('shown.bs.tab', function (e) {
            ;(I = t(e.target).attr('href')), t('#getsec').val(I)
            var a = location.href.split('#')[0] + I
            history.replaceState(null, null, a),
              '#location' == I &&
                (R(), t('#wpol-admin-map').length && C.updateSize())
          }),
          ...
          t('#pp_type').on('change', function () {
            '_donations' === t(this).val()
              ? (z.addClass('d-none'), y.removeClass('col-sm-3'))
              : (z.removeClass('d-none'), y.addClass('col-sm-3'))
          }),
          P.on('input', function () {
            var e = P.val()
            t.ajax({
              method: 'POST',
              url: V + 'ajax/btc-check.php',
              data: { btc_account: e },
            }).done(function (t) {
              t
                ? P.removeClass('is-invalid').addClass('is-valid')
                : P.removeClass('is-valid').addClass('is-invalid')
            })
          })
      })
    },
