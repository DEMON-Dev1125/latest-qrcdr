...
<rect x="4.1" y="3.1" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -1.1573 4.2063)" width="0.7" height="0.7"/>',
    ...
    'sparkle' => array(
        'path' => '<path d="M3,7.2L2.7,5.6C2.4,4.5,1.5,3.6,0.4,3.3L-1.2,3l1.6-0.3c1.2-0.2,2.1-1.1,2.3-2.3L3-1.2l0.3,1.6 c0.2,1.2,1.1,2.1,2.3,2.3L7.2,3L5.6,3.3C4.5,3.6,3.6,4.5,3.3,5.6L3,7.2z"/>',
        'rotate' => false,
